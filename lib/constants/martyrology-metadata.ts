...
export enum PatronTitle {
  ...
  CopatronOfTheArchidiocese = 'COPATRON_OF_THE_ARCHIDIOCESE',
  CopatronOfTheDiocese = 'COPATRON_OF_THE_DIOCESE',
  ...
  PatronOfTheArchidiocese = 'PATRON_OF_THE_ARCHIDIOCESE',
  PatronOfTheMetropoly = 'PATRON_OF_THE_METROPOLY',
